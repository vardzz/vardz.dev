...
export default function GhostNetPage() {
  return (
    <ProjectTemplate
      ...
      responsibilities="I designed the system architecture, built the core infrastructure, and directed a five-member team through development. I engineered the web scraping pipeline to intercept phishing and typosquatting threats, and integrated the Gemini API to automate the analysis of scraped data."
    ...
    >
      <TeamTemplate
        ...
        imageSrc="/projects/ghostnet/devnumero.png"
        imageAlt="DEVNUMERO"
      />
    </ProjectTemplate>
  );
