    ...
    >
      <div className="flex flex-col items-center text-center px-6 pb-24 md:pb-28">
        ...
        <a 
          ...
          className="flex items-center gap-6 w-full max-w-[620px] h-[100px] p-5 rounded-[24px] bg-[#161616] border border-[#F4EDE4]/10 select-none transition-all duration-300 hover:scale-[1.02] hover:border-[#F4EDE4]/20 hover:shadow-[0_0_20px_rgba(244,237,228,0.03)]"
        >
          {/* Logo */}
          ...
          <div className="flex flex-col flex-1 min-w-0 text-left leading-tight gap-1.5">
            <span className="font-bold text-xl tracking-tight text-[#F4EDE4]">Gridworks</span>
            <span className="text-base text-[#F4EDE4]/60">
              on <strong className="font-bold text-[#F4EDE4]">App Builders PH</strong>
            </span>
          </div>

          {/* Metric */}
          <div className="flex flex-col items-center justify-center w-[100px] h-full rounded-2xl bg-[#F4EDE4] text-[#111111] leading-none px-1">
