  ...
  return (
    <section className="py-[54px] md:py-[70px]" id="stack">
      ...
      <div className="flex flex-wrap gap-[9px]">
        <span className="border border-line text-soft rounded-[6px] px-[12px] py-[9px] text-[13px]">JavaScript</span>
        ...
        <span className="border border-line text-soft rounded-[6px] px-[12px] py-[9px] text-[13px]">Tailwind CSS</span>
