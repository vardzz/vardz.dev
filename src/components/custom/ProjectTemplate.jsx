        ...
        <div className={`relative flex flex-1 items-center justify-center bg-[#F4EDE4] px-6 md:pl-28 md:pr-24 lg:pl-24 lg:pr-24 text-[#111111] pt-75`}>
          <div className="w-full flex items-center justify-center">
            <motion.h1
              ...
              className="font-heading font-display text-[clamp(3rem,14vw,14rem)] font-black uppercase leading-[0.78] tracking-[-0.08em] text-center transform md:translate-x-10"
            >
              {projectName}
            </motion.h1>
          </div>
